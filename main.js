          ...
          <div class="lg:col-span-5">
            <div class="glass rounded-2xl sm:rounded-3xl shadow-2xl p-5 sm:p-8 h-full lg:min-h-[620px]">
              ...
              <div class="space-y-5 sm:space-y-6 text-base sm:text-lg" id="resumen">
                ...
                <div class="flex justify-between gap-4 text-2xl sm:text-3xl font-bold"><span class="text-gray-dark">Total</span><strong id="total" class="text-naranja">Bs 0,00</strong></div>
              </div>
            </div>
          </div>
        </div>
